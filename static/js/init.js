(function($) {
	...
	skel.init({
		...
		breakpoints: {
			...
			normal:		{ range: '-1280', href: '/static/css/style-normal.css', containers: 960, viewport: { scalable: false } },
			narrow:		{ range: '-980', href: '/static/css/style-narrow.css', containers: '95%', grid: { gutters: 30 } },
			narrower:	{ range: '-840', href: '/static/css/style-narrower.css', containers: '95%!', grid: { zoom: 2 } },
			mobile:		{ range: '-736', href: '/static/css/style-mobile.css', containers: '100%!', grid: { zoom: 3 } }
		},
		plugins: {
			layers: {
				config: {
